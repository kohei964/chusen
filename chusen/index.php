...
<head>
    ...
    <link rel="stylesheet" href="https://webweavelab.com/chusen/assets/style.css?v=1.1">
</head>
<body>
    <div class="container py-5">
        ...
        <!-- ボタンセクション -->
        <div id="control-buttons" class="d-flex justify-content-center gap-3 mb-5" style="display: none;">
            <button id="draw-button" class="btn btn-primary">抽選する</button>
            <button id="end-button" class="btn btn-success">終了する</button>
            <button id="clear-history-button" class="btn btn-danger">履歴を消去</button>
        </div>
    ...
    <script src="https://webweavelab.com/chusen/assets/script.js"></script>
</body>
</html>
Bootstrapを全て外せ
